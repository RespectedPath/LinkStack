...
module.exports = [
  ...
  { slug: 'nail-tech',    name: 'Nail Tech',    category: 'Beauty', archetype: 'bloom', accent: '#B6A6C9', treatment: 'solid', icon: 'droplet',
  ...
  { slug: 'lash-tech',    name: 'Lash Tech',    category: 'Beauty', archetype: 'bloom', accent: '#C99BB0', treatment: 'solid', icon: 'eye',
  ...
  { slug: 'therapist',    name: 'Therapist',    category: 'Professional', archetype: 'studio', accent: '#4E6E5D', treatment: 'solid', icon: 'brain',
