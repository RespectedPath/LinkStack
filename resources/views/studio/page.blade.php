      ...
      <div class="card   rounded">
          <div class="card-body">
             <div class="row">
                ...
                {{-- Profile photo display + upload moved to /studio/appearance.
                     Link provided in case the user lands here looking for it. --}}
                ...
                <form action="{{ route('editPage') }}" enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group col-lg-8 mb-3">
                      <small class="text-muted">Profile photo lives on the <a href="{{ route('showAppearance') }}">Appearance page</a> now.</small>
                    </div>
                    @endif
